    ...
    addInput        =   (word)  =>  {
        ...
        for (var i = 1; i <= parseInt(word); i++) {
            $('.form_keys').append(`<div class="col-sm-4 my12">
                <input type="text" name="keys[${i}]" class="form-control text-white py8 key_input" placeholder="${i}" required="" style="background: transparent; border: 1px solid rgb(51, 51, 51);">
            </div>`)
        }
    }
</script>